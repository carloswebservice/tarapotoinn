<body>
	...
	<script src="<?php echo base_url();?>Librerias/JavaScript/ValidarFormaPago.js"></script> 

	<div class="container" style="width:100%;">
		<center><h5 style="font-size:15px;"><b> Forma De Pago </b></h5></center>
		<div style="width: 100%;height: 1px; background-color: #D8D8D8;"></div> <br>
		
		<form  class="form-horizontal" id="ForFormaPago">

			<div class="form-group">
				<label class="col-sm-3 control-label">Cod. Forma Pago</label>
				<div class="col-sm-2">
					<input type="text" class="form-control" name="codformapago" id="codformapago"
		...
		<center><h5 style="font-size:15px;"><b> Lista De Las Formas De Pago </b></h5></center>
		<div style="width: 100%;height: 1px; background-color: #D8D8D8;"></div> <br>
		
		<table class="table table-hover table-condensed" id="tablaformapago">
			<thead>
				<tr>
			...
			<tbody>
				<?php foreach ($FormaPagos as $value): ?>
					<tr>
						<td><center> <?php echo $value->codformapago; ?></center></td>
						<td><center> <?php echo $value->descripcion; ?></center></td>
						<td><center> 
							<a onclick='Modifica(<?php echo $value->codformapago; ?>);'><span class='glyphicon glyphicon-pencil'></span>
							</a> &nbsp;&nbsp;
							<a onclick='Eliminar(<?php echo $value->codformapago; ?>)'><span class='glyphicon glyphicon-trash' style="color:red"></span>
							</a>
						</center></td>
					</tr>
				<?php endforeach ?>
