        ...
        <main id="wrapper">
            ...
            <section id="ec-content">                
                <section class="ec-tops">                                                      
                    <h4>CONTACTO</h4>
                    <img src="<?php echo base_url();?>imageneshotel/info.png" class="contac">
                    <p style="margin-left:40px;margin-top:-20px;margin-bottom:10px">Hotel Tarapoto Inn Jr. Jimenez Pimentel Nº 115
                        <br>
                        Tarapoto - Perú
                    </p>
                    <img src="<?php echo base_url();?>imageneshotel/tel.png" class="contac">
                    <p style="margin-left:40px;margin-top:-20px;margin-bottom:10px">042-524213
                        <br>
                        042-341648
                        <br>
                        #440704
                    </p>
                    <img src="<?php echo base_url();?>imageneshotel/mail.png" class="contac">
                    <p style="margin-left:40px;margin-top:-20px">informes@hoteltarapoto.com
                    </p>                              
                    <h4>MAPA</h4>
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3964.2590802312425!2d-76.3623220856369!3d-6.488841365245601!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x91ba0c08893535cb%3A0x99ad097213b0bfd7!2sHotel+Tarapoto+Inn!5e0!3m2!1ses!2spe!4v1447604277484" width="100%" height="350" frameborder="0" style="border:0" allowfullscreen></iframe>
                </section>      
            </section>
