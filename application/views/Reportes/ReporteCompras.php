<body>
	...
	<div class="container" style="width:100%;"> <br>
		<div class="row">
			...
			<div class="col-md-6">
				<center><h5 style="font-size:15px;"><b> Lista Compras Del Hotel</b></h5></center>
			</div>
			<div class="col-md-3">
				<center><a href="<?php echo base_url();?>Reportes/ImprimirCompras" target="_blank" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-print"></span> Imprimir</a></center>
			</div>
		</div>
