<body>
	...
	<script src="<?php echo base_url();?>Librerias/JavaScript/ValidarTipoProducto.js"></script> 

	<div class="container" style="width:100%;">
		<center><h5 style="font-size:15px;"><b> Tipo De Producto </b></h5></center>
		<div style="width: 100%;height: 1px; background-color: #D8D8D8;"></div> <br>

		<form  class="form-horizontal" id="ForTipoProducto">
			<div class="form-group">
				<label class="col-sm-3 control-label">Codigo</label>
				<div class="col-sm-2">
					<input type="text" class="form-control" name="codtipoproducto" id="codtipoproducto" 
		...
		<center><h5 style="font-size:15px;"><b> Lista De Tipo de Productos </b></h5></center>
		<div style="width: 100%;height: 1px; background-color: #D8D8D8;"></div> <br>
		
		<table id="tablatipoproductos">
			<thead>
				<tr>
			...
			<tbody>
				<?php
				foreach ($TipoProductos as $value): ?>
					<tr>
						<td><center> <?php echo $value->codtipoproducto; ?></center></td>
						<td><center> <?php echo $value->descripcion; ?></center></td>
						<td><center> 
							<a onclick='Modifica(<?php echo $value->codtipoproducto; ?>);'><span class='glyphicon glyphicon-pencil'></span>
							</a> &nbsp;&nbsp;
							<a onclick='Eliminar(<?php echo $value->codtipoproducto; ?>)'><span class='glyphicon glyphicon-trash' style="color:red"></span>
							</a>
						</center></td>
					</tr>
				<?php endforeach ?>
...
<style type="text/css">
	...
	#tablatipoproductos th{
		border:1px solid #D8D8D8;
		padding:5px 10px;
		font-size: 13px;
		text-align: center; 
	}
	#tablatipoproductos td{
		border:1px solid #D8D8D8;
		padding:5px 10px;
		font-size: 13px;
		text-align: center; 
