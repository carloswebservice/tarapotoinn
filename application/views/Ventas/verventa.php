	...
	<div class="container" style="width:100%;">	 <br>	
		<div>
		  	<ul class="nav nav-tabs nav-justified" role="tablist" id="navegar">
		    	<li role="presentation" class="active"><a href="#verventas" role="tab" data-toggle="tab" style="color:black;"><span class="glyphicon glyphicon-shopping-cart"></span> Venta</a></li>
		  	...
		  	<div class="tab-content">
		  		<!-- Para Ver La Estadia -->
			    <div role="tabpanel" class="tab-pane active" id="verventas"> <br> <br>
			    	<form  class="form-horizontal" id="Ver">
			            ...
			            <div class="form-group">
			                <table id="tabladetalleventa">
								...
								<tbody>
									<?php foreach ($DetalleVenta as $value): ?>
										<tr>
